...
<body>
    <img src="https://i.ibb.co/rbtg8zz/ucalogo.png" alt="ucalogo" style="margin-left: 500px; margin-right: 500px;">
        ...
        <h1 class="foro" style="text-align: center;">Materias Segundo Año</h1>
    <ul class="navbar">
    ...
    <?php
            ...
            $sql = "SELECT `subj_id`, `subj_name`, `subj_year`, `subj_semester` FROM `subjects` WHERE `subj_year` IN ('2');";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                if(in_array($row['subj_id'], $array)) {                      
                        ...
                        <input type="submit" class="barra" value="Desuscribirse"> </form> '. $row['subj_name'] .'</td>
                    ...
                    <input type="submit" class="barra" value="Suscribirse"> </form> '. $row['subj_name'] .'</td>
                    <td>'. $row['subj_semester'] .'</td>
                    </tr>
                    <tr>';
                }   
